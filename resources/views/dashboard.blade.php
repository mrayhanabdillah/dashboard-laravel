...
@section('content')
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Target Vote</p>
                                {{-- <h5 class="font-weight-bolder mb-0">
                                    +3,462
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <h5 class="font-weight-bolder mb-0">{{ count($pendingVote) }}</h5>
                            </div>
                        </div>
                        <div class="col-4 text-end">
                            <div class="icon icon-shape bg-gradient-info shadow text-center border-radius-md">
    ...
    <div class="row mt-4">
        <div class="col-lg-4 mb-lg-0 mb-4">
            <div class="card">
                <div class="card-body p-3">
                    <h5 class="font-weight-bolder">Dashboard Program</h5>
                    <div class="d-grid">
                        @foreach ($programs as $program)
                            <a class="btn btn-info"
                                href="{{ route('dashboard-program', $program->id) }}">{{ $program->name }}</a>
                        @endforeach
        ...
        <div class="col-lg-8">
            <div class="card p-3">
                <h5 class="font-weight-bolder">Pending Vote</h5>
                <div class="card-body">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center" id="pending-vote">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($pendingVote as $index => $voting)
                                    <tr>
                                        <td class="ps-4">
...
@push('dashboard')
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#pending-vote').DataTable({
                responsive: true,
            });
